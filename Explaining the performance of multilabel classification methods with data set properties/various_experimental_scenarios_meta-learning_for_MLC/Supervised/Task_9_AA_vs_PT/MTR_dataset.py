...
def createArff(csv, columns, chooseMetric):
    ...
    with open("/home/matilda/PycharmProjects/MetaLearningForMLC/Meta_learning_MLC/LearningScenarios/Supervised/Task_9_AA_vs_PT/dataset_clus_" + chooseMetric + "_.arff", "w") as file:
        arff.dump(d, file)
...
trainSet = pd.read_csv("/home/matilda/PycharmProjects/MetaLearningForMLC/Meta_learning_MLC/LearningScenarios/Supervised/Task_9_AA_vs_PT/targets.csv")
...
settings_file  = "/home/matilda/PycharmProjects/MetaLearningForMLC/Meta_learning_MLC/LearningScenarios/Supervised/Task_9_AA_vs_PT/settings_file.s"

with open(settings_file, "r") as file:
    content = file.readlines()

content[1] = "File = /home/matilda/PycharmProjects/MetaLearningForMLC/Meta_learning_MLC/LearningScenarios/Supervised/Task_9_AA_vs_PT/dataset_clus_"+ metric +"_.arff \n"
