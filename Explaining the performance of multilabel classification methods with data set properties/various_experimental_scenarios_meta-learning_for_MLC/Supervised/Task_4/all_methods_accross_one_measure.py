...
metriccccc = ["HAMMING_LOSS_example_based"]
fin_fin_res = ['MLkNN', 'MLARM', 'DEEP1',
        ...
        for metric in metriccccc:
            ...
            while x<numDatasetsTest:
                ...
                if integ in pomList:
                    ...
                    for id_el, el in enumerate(targets):
                        if el == method:
                            targets.pop(id_el)
            ...
            res_all_nodes[metric] = qqqqq
        vvvv.append(res_all_nodes)
