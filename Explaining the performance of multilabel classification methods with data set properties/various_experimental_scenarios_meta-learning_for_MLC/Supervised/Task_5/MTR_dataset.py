...
settings_file  = "/home/matilda/PycharmProjects/MetaLearningForMLC/Meta_learning_MLC/LearningScenarios/Supervised/Task_5/settings_file.s"
...
metric = "HAMMING_LOSS_example_based"
...
#    with open("dataset_clus.arff", "w") as file:
#        arff.dump(d, file)




non_scaled = pd.read_csv("/home/matilda/PycharmProjects/MetaLearningForMLC/Meta_learning_MLC/LearningScenarios/Supervised/Task_5/metaDataSet.csv")
...
createArff(fin.values, fin.columns)
